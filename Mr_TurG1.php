...
#Dilarang copyright Mr.TurG1 - FaturAzis 2018 15 08 12:30
...
echo $BB."\n::#:Author ::[Fatur Rahman Azis] #";

echo $B."\n::#:Instagram ::[@fatur.azis:]#";

echo $RR."\n::#:Github ::[http://github.com/faturazis91:] #";

echo $R."\n::#:Facebook ::[Fatur Rahman Azis:] #";
...
if(is_numeric($argv[1])) {
	...
	while(1) {
		...
		echo "[]Mr.TurG1 Sending Massage To[] # ".$G.$argv[1].$X."\n";	
